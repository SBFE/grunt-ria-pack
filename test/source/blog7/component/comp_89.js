...
$registComp(89, {
	"load" : function () {
		this.setContent('<div class="cloneWidget" style="padding:0px;"'
			+ '><div class="finance' + this.size + (this.size == 210 ? "-2" : "") + '" '+ ($isAdmin ? 'style="padding-bottom:10px;"' : '')
			+ '><div id="comp_' + this.compId + '_content" class="tag_contants2"></div></div>'
