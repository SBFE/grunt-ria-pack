...
$registComp(8, {
	...
	"load"		: function () {
		var musicPlayer = ['<div class="widgetcen" style="height:395px;">'
			...
			, '</div></div></div>' +
			(!$isAdmin ? '<div class="cloneLink">'
			+ '<a title="添加到我的博客" href="#" onclick="Lib.Component.clone(8, '
			+ this.size + ');return false;"><img alt="" src="http://simg.sinajs.cn/blog7style/images/widget/add1.gif" /> '
			+ '添加到我的博客</a></div>' : '')
			+ '</div></div>'].join("");
		...
		var addFlash = function () {
				var sinaFlash2 = new sinaFlash("http://music.sina.com.cn/shequ/player/sina_music1_2_1.swf?1", "bmp_Music"
					, "100%", "395", "9", "#FFFFFF", false, "High"
