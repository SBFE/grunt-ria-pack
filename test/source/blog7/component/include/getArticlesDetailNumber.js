...
$ScriptLoader = {
	...
	,response :  function (sId, oData) {
	    ...
	    if(pageId == 'article' || pageId == 'articleM' || !pageId.indexOf('articletj')) {
...
App.getArticlesDetailNumber = function (sUid, aArticleLists, fCallBack){
	...
	//王京提供 2011-06-07
	js.src = "http://blogtj.sinajs.cn/api/num.php?uid=" + sUidHex + "&aids=" + aids.join(",") + "&requestId=" + requestId;
