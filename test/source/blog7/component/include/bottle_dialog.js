...
//            Utils.Flash.swfView.Init();
        ...
        var cardStyle = '<div style="display: none;">&nbsp;\
			<style>\
				...
				.blog_bottle_msg_bg_bottom {height:23px;bottom:0;top:auto;background:url(' +
        bgIMGPath +
        ') no-repeat -1091px 0;}\
				.blog_bottle_msg_content {position:relative;color:#ccc;}\
				.blog_bottle_msg_close {position:absolute;right:6px;top:6px;width:14px;height:14px;background:url(' +
        bgIMGPath +
        ') no-repeat -1089px -39px;cursor:pointer;}\
				...
				.blog_bottle_send_btn {width:60px;height:22px;background:url(' +
        bgIMGPath +
        ') no-repeat -1233px -76px;cursor:pointer;border:0;}\
				.blog_bottle_reply_btn {width:60px;height:22px;background:url(' +
        bgIMGPath +
        ') no-repeat -1091px -76px;cursor:pointer;border:0;}\
				.blog_bottle_cancel_btn {width:60px;height:22px;background:url(' +
        bgIMGPath +
        ') no-repeat -1160px -76px;cursor:pointer;border:0;}\
				.blog_bottle_close_btn {width:60px;height:22px;background:url(' +
        bgIMGPath +
        ') no-repeat -1305px -76px;cursor:pointer;border:0;}\
				...
				{display:none;}\
				.blog_bottle_status_reply_mini .blog_bottle_msg_bg_middle {background:url(' +
        bgIMGPath +
        ') no-repeat -554px 0;}\
				...
				{display:inline;}\
				/*回复许愿瓶完成*/\
				.blog_bottle_status_reply_ok .blog_bottle_msg_bg_top {background:url(' +
        bgIMGPath +
        ') no-repeat -283px -508px;}\
				.blog_bottle_status_reply_ok .blog_bottle_msg_bg_middle {background:url(' +
        bgIMGPath +
        ') no-repeat -12px 0;}\
				...
				.blog_bottle_status_send_ok .blog_bottle_msg_bg_middle {background:url(' +
        bgIMGPath +
        ') no-repeat -12px 0;}\
				...
				{display:none;}\
				.blog_bottle_status_send .blog_bottle_msg_bg_top {background:url(' +
        bgIMGPath +
        ') no-repeat -283px 0;}\
				.blog_bottle_status_send .blog_bottle_msg_bg_middle {background:url(' +
        bgIMGPath +
        ') no-repeat -823px 0;}\
