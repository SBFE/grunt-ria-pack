...
$registComp("10009", {
	"pagesize": 5
	,"interfaceSaveSet": new Interface('http://control.blog.sina.com.cn/riaapi/tshow/write_component.php', 'jsload')
	,"interfaceReadSet": new Interface('http://control.blog.sina.com.cn/riaapi/tshow/read_component.php', 'jsload')
	,"interfaceShow" : new Interface('http://control.blog.sina.com.cn/riaapi/appMake_Show.php', 'jsload')
	,"conf": {skin:1, isTitle:1, isWeibo:1, isFans:1, fansRow:1} //用于保存的配置
	...
	,"tpl":['<table id="#{entity}" class="CP_w">',
			...
			'<tbody>',
				'<tr>',
					...
					'<div class="CP_layercon2" id="#{trueContent}" style="display:none">',
