...
//			,"varname": "tjData"
            ...
            onComplete: (function(result){
               var tp = '<li><p><span class="SG_dot"></span><a href="#{href}" target="_blank">#{content}</a></p>'
			   			+ '<div class="w_list SG_txtc"><a href="#{srcHref}" target="_blank">#{src}</a></div></li>';
               var content = "";
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    info.content = Core.String.byteLength(data[i].blog_title) > 26
										? Core.String.shorten(data[i].blog_title, 26, "…")
										: data[i].blog_title;
