...
$registComp(901, {
    ...
    + '<img src="http://portrait' + (scope.$uid * 1 % 8 + 1) + '.sinaimg.cn/' + scope.$uid + '/blog/180" id="comp_901_head_image" width="180" height="180" alt="" />'
    + '</div>'
    + '<div class="info_txt">'
    + '<div class="info_nm">'
    + '<img id="comp_901_online_icon" style="display:none;" class="SG_icon SG_icon1" src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" width="15" height="15" align="absmiddle" /><span class="SG_txtb"><strong id="comp_901_nickname">&nbsp;</strong></span>'
    + '<span class="info_into"><a class="SG_linka" href="http://space.sina.com.cn/u/1406758883"><img class="SG_icon SG_icon41" src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" width="15" height="15" title="空间" align="absmiddle" />进入我的空间</a></span>'
    + '<div class="clearit"></div>'
    + '</div>'
    + '<div class="info_btn1">' //flm
    + '<a href="http://you.video.sina.com.cn/' + scope.$uhost + '" class="SG_aBtn SG_aBtn_ico" target="_blank">'
    + '<cite>'
    + '<img class="SG_icon SG_icon16" src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" width="15" height="15" align="absmiddle" />播客'
    + '</cite>'
    + '</a><a href="http://weibo.com/' + scope.$uid + '?source=blog" class="SG_aBtn SG_aBtn_ico">'
    + '<cite>'
    + '<img class="SG_icon SG_icon51" src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" width="15" height="15" align="absmiddle" />微博'
    + '</cite>'
    + '</a>'
    + '<div class="clearit"></div>'
    + '</div>' //flm
    ...
    + '<ul class="info_list1">'
    + '<li>'
    + '<span class="SG_txtc">博客等级：</span><span id="comp_901_grade">读取中…</span>'
    + '</li>'
    + '<li>'
    + '<span class="SG_txtc">博客积分：</span><span id="comp_901_score">读取中…</span>'
    + '</li>'
    + '</ul>'
    + '<ul class="info_list2">'
    + '<li>'
    + '<span class="SG_txtc">博客访问：</span><span id="comp_901_pv">读取中…</span>'
    + '</li>'
    + '<li>'
    + '<span class="SG_txtc">关注人气：</span><span id="comp_901_attention">读取中…</span>'
    + '</li>'
    + '</ul>'
    + '</div>'
    + '<div class="clearit"></div>'
...
/*     昵称长度由PHP控制           
        ...
        && scope.$private.ad == 0 && scope.$private.adver == 0 && scope.$private.p4p == 0) {
            this.setManage();
        }
    }
    /**
    ...
    renderHead : function(nickname) {
        if(!$isAdmin) {
            ...
            $E("comp_901_head").innerHTML = '<a href="http://control.blog.sina.com.cn/blogprofile/nick.php"'
            + ' title="点击上传头像" target="_blank"><img id="comp_901_head_image" width="180" height="180" alt="点击上传头像" src="http://portrait' + (scope.$uid * 1 % 8 + 1) + '.sinaimg.cn/' + scope.$uid + '/blog/180" /></a>';
        }
    }
    /*
     * 加载其他的附加信息接口
            ...
            Utils.Io.JsLoad.request("http://blogcnfv5.sinajs.cn/blogscr?uid=" + scope.$uid + "&varname=blogScore&.js", {
                onComplete: function() {
                    ...
                    if(typeof blogScore != "undefined" || $E("comp_901_score") == null) {
                        ...
                        $E("comp_901_score").innerHTML = '<strong>'
        ...
        attention.request({
            ...
            onSuccess		: Core.Function.bind2( function (oData) {
                ...
                if( typeof oData.userpoint != "undefined" ) {
                    if($E('comp_901_score')) {
                        $E('comp_901_score').innerHTML = '<strong>' + oData.userpoint + '</strong>';
                    }
                }
                if(this.mashAddFriend) {
                    //还原回原来的返回格式，方便代码复用
    ...
    "loadAdManage"		: function () {
        if(	$isAdmin
        && scope.$private != null && scope.$private.ad != null && scope.$private.ad != 0
        && $E("comp_901_adlink") == null) {
            Debug.info("添加广告共享计划管理链接");
            var adHTML = ['<div class="info_locate2"><div class="SG_j_linedot"/></div>'
            + '<div id="comp_901_adlink" class="info_AD"><a href="http://share.sass.sina.com.cn/widget_ad/widget_ad_index.php"'
            + ' target="_blank">管理广告共享计划</a></div>'].join("");
    ...
    "showVisitButton" : function() {
        ...
        if ($E('info_locate_id')) {
            ...
            , '<div class="info_btn2">'
            , '<p><a href="#" onclick="' + inviteButtonHTML
            , '</cite></a>'
            , '<a href="#" onclick="Lib.scrip(' + scope.$uid + ');return false;" class="SG_aBtn">'
            , '<cite>发纸条</cite></a></p>'
            , '<p><a href="http://blog.sina.com.cn/s/profile_' + scope.$uid
            + '.html#write" class="SG_aBtn" target="_blank">'
            , '<cite>写留言</cite></a>'
            , '<a id="module_901_attention" href="#" onclick="return false;" class="SG_aBtn'
            + (this.isAttentioned ? ' SG_aBtn_dis' : '') + '">'
