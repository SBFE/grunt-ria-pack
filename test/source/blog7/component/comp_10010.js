...
$registComp("10010", {
	"url": "http://control.blog.sina.com.cn/blog_rebuild/riaapi/profile/feed/getAttenFeedList.php"
	,"getElemByCls": Core.Dom.getElementsByClass
	/*
	 * 730 像素宽度的模版
	 */
			...
			onComplete : function(result){
				if (result.code && result.code === "A00006"){
					if (result.data && result.data.items && result.data.items.length != 0){//有数据显示
						...
						__this.limitCount = result.data.c_count;	//需要渲染的个数
