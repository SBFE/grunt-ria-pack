...
$registComp(123, {
	"load" : function () {
		...
		this.setContent('<div class="cloneWidget" ' + (this.size != 730? 'style="padding:0px 10px;"' : 'style="padding:0px 20px;"') 
			+ '><div id="comp_' + this.compId + '_content" style="padding-top:10px;padding-bottom:10px;"> ' + template + '</div></div>'
