		...
		if(oData.length == 0){
			...
			Core.Array.foreach(oData, Core.Function.bind2(function (oItem) {
				...
				oItem.manage = $isAdmin
					? '<span class="option"><a href="#" onclick="Lib.deleteWallByMsgid(\''
							 + oItem.msgid + '\', ' + oItem.uid + ', Core.Function.bind2(Lib.Component.instances['
							+ this.compId + '].reload, Lib.Component.instances[' + this.compId + ']));return false;" class="CP_a_fuc">[<cite>删除</cite>]</a></span>'
					: '';
...
//			}
			result += '<div class="toDoBar"><span class="SG_more SG_floatR"><a href="http://blog.sina.com.cn/s/profile_'
					+ scope.$uid + '.html#module_942" target="_blank">更多</a>&gt;&gt;</span>'
					+ '<a href="http://blog.sina.com.cn/s/profile_' + scope.$uid + '.html#write" class="SG_aBtn"'
					+ ' target="_blank"><cite>写留言</cite></a></div>';
