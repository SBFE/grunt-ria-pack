...
//		if(this.isPlayerInit == null || $E("comp_10005_playlist") == null){
			this.setContent([ (!$isAdmin ? '<div class="cloneWidget">' : '') + 
					'<div class="'+ this.cntClass + '">'
...
//				Debug.dir(oPageData);
	...
	,"showList" : function (oPageData) {
		...
		// 渲染列表
		var html = '<li id="comp_10005_#{vid}_#{uid}" class="SG_j_linedot1">'
					+ '<div class="SG_dot"></div><a href="#" '
					+ 'onclick="playMyVideo(#{vid}, #{uid});return false;" title="#{name}">#{shortName}</a></li>';
