...
$registComp(93, {
	...
	,"createIframe"		: function () {
		...
		var miniblog_url = "http://service.weibo.com/widget/widget_blog.php?uid=" + scope.$uid
					+ "&width=" + miniblog_width + "&height=" + miniblog_height;//下线skin参数 + "&skin=" + scope.tpl;
		var miniblog = '<iframe src="' + miniblog_url + '" frameborder="0" scrolling="no" allowtransparency="true" style="width:'
					+ miniblog_width+ 'px;height:' + miniblog_height+ 'px;margin:10px;"></iframe>';
