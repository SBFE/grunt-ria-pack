    ...
    load : function(){
        ...
        Utils.Io.JsLoad.request('http://control.blog.sina.com.cn/blog_rebuild/riaapi/blog/getAssocData.php', {
            ...
            onComplete  : function(result){
                ...
                var articleCon = result && result.data && result.data.msg &&result.data.msg.assoc,
                    tuijianInfo = result && result.data && result.data.msg && result.data.msg.tuijian.tuijiandata;
                 //热文排行渲染
                var struc = "",shortCon,
                    tuijianLen =tuijianInfo.length;
