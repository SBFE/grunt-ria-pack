            ...
            onComplete  : function(result){
	    		...
	    		for(var i = 0; i < data.length; i++){
	    			if(data[i].pic){
	    				...
	    				detail = '<p class="more">'+
	    							'<a href="http://blog.sina.com.cn/s/blog_'+ data[i].blog_id +'.html" target="blank">详细&gt;&gt;</a>'+'</p>'+
	    							'<div class="clearit"></div>'+
	             				'</div>'+
	                        '</li>';
	    			}else{
	    				imgs = '';
	    				detail = '<div class="clearit"></div>'+
	             				'</div>'+
	             				'<p class="more">'+
	    							'<a href="http://blog.sina.com.cn/s/blog_'+ data[i].blog_id +'.html" target="blank">详细&gt;&gt;</a>'+'</p>'+
	                        '</li>';
	        		...
	        		struc += '<li class="last">'+
	                            '<div class="article_tit"><a href="http://blog.sina.com.cn/s/blog_'+ data[i].blog_id +'.html" target="blank">'+ data[i].blog_title +'</a></div>'+
	                            '<div class="articlelist">'+
	                                imgs
	                                + '<p>'+ data[i].body_body +'</p>'+ detail;
