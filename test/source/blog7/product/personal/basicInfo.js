...
//			(new Interface("http://icp.cws.api.sina.com.cn/profile/show_baseDetail.php", "jsload")).request({
			...
			function _updateShowData(iData){
				...
				if (iData["fullDate"]!="2" && iData["year"] && iData["month"] && iData["day"]) {
					haveData=true;
					var hashDate={
						"0":'<a target="_blank" href="http://uni.sina.com.cn/c.php?t=ren&st=1&gend=0&prov=0&city=0&age_min=0&age_max=0&byea='+iData["year"]+'">'+iData["year"]+'年</a> '+
							'<a target="_blank" href="http://uni.sina.com.cn/c.php?t=ren&st=1&gend=0&prov=0&city=0&age_min=0&age_max=0&bmon='+_this.formatNumber(iData["month"])+_this.formatNumber(iData["day"])+'">'+iData["month"]+'月'+iData["day"]+'日</a> '+
				...
				if(iData["place1"]){
					...
					valueRows.push('<tr>'+
										...
										'<td class="rolTd2"><span class="tdP20"><a target="_blank" href="http://uni.sina.com.cn/c.php?t=ren&st=1&gend=0&prov=0&city=0&age_min=0&age_max=0&prov='+searchPlace1+'">'+iData["place1"]+'</a></span>');
					if(iData["place2"]){
				...
				if(iData["hometown1"]){
					...
					valueRows.push('<tr>'+
										...
										'<td class="rolTd2"><span class="tdP20"><a target="_blank" href="http://uni.sina.com.cn/c.php?t=ren&st=1&gend=0&prov=0&city=0&age_min=0&age_max=0&bpro='+searchHometown1+'">'+iData["hometown1"]+'</a></span>');
					if(iData["hometown2"]){
