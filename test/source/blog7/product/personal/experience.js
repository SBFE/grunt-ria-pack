	...
	initialize:function(){
		...
		function appendSchool(){
			...
			td2.innerHTML='<div class="posSchool"><span class="tdP20">'+
											...
											'<p style="display:none;" id="msgAddNewSchool'+schoolIndex+'" class="errorAction addForm">未找到该学校，请输入正确的学校名称或<a id="addNewSchool'+schoolIndex+'" href="javascript:;">申请添加该学校</a></p>'+
										'</div>';
