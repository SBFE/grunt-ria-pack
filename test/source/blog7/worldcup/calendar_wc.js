...
CalendarWc.prototype = {
	...
	initialize:function(){
		...
		Core.Events.addEvent(this.closeBtn, function(){ _this.resetCalendar(); });
	...
	tweenPlay : function(){
		...
		new Ui.tween(
			this.fakeImg,
			["opacity", "height", "width", "left"],
			[1, this.entity.offsetHeight-4, this.entity.offsetWidth-4, Core.Dom.getLeft(this.posRelDom)-217],		//-4 是 border。
			0.3,
			"strongEaseIn",
