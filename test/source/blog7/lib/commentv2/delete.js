...
CommentV2.Delete = function(opt){
	...
	deleteComment: function(opt, delSucc){
		...
		this.del_url = new Interface("http://control.blog.sina.com.cn/admin/comment_new/cms_del_post.php", $IE6 ? "ijax" : "jsload");
	...
	deleteReply: function(opt, delSucc){
		...
		this.del_url = new Interface("http://control.blog.sina.com.cn/admin/comment_new/cms_del_usereply_post.php", $IE6 ? "ijax" : "jsload");
