...
$registJob("hotAdvertise", function(){
    ...
    var html = '<div class="SG_conn" id="hotShangPin"></div>';
    Utils.insertTemplate(module_911, html, 'AfterEnd');
    // 精彩图文下方增加热卖商品广告
    Lib.execZhitou(function(res){
        blogAd.insertIns('PDPS000000052389', $E("hotShangPin"), 'Afterbegin');
        (window.sinaads || []).push({});
    });
    ...
    Lib.execZhitou(function(res){
        ...
        (window.sinaads || []).push({
            params : {
                sinaads_ad_tpl : '<li class="SG_j_linedot1"><p class="atcTitCell_tit SG_dot"><a target="_blank" href="#{link}" onclick="try{#{monitor}}catch(e){}">#{src}</a></p><p class="atcTitCell_nm"><a target="_blank" href="#{link}" onclick="try{#{monitor}}catch(e){}" class="SG_linkb" style="display:inline-block;height:14px; line-height:14px; white-space:normal; overflow:hidden;">#{src1}</a></p></li>'
            }
        });
    });
