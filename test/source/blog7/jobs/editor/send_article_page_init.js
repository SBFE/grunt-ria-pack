...
$registJob("send_article_page_init", function(){
    ...
    $E("articleTagAutoSub").onclick = function(){
        ...
        $E("editorForm").action = _CFG.tagPostURL; //'http://keyword.sina.com.cn/tagAnl/blog_tagword.php'; //
        Core.Events.addEvent($E("tagDataIframe"), Core.Function.bind3(tagFunc, this, [$E("tagDataIframe"), function(frmJson){
            ...
            switch (frmJson.code) {
                case "B00000":
                    break;
                case "B00006": addAutoTags(frmJson.data);
				...
				case "00001":
                    ...
                    break;
				case "00006": addAutoTags(frmJson.data);
                    //$E("articleTagInput").style.color = "#000";
                    //$E("articleTagInput").value = frmJson.data;
                    break;
                default:
...
//                    });
            ...
            v7sendLog('48_01_01_'+frmJson.code, 'editor'); //liming9@2012年10月29日
        }]), "load");
        $E("editorForm").submit();
		return false;
    };
