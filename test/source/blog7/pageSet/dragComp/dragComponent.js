                ...
                for (var j = 0; j < this.columnCompInfo["column_" + columnIn].length; j++) {
                    ...
                    if (result.up) {//拖拽到了该元素的上半部分，应该将border添加到该元素上面
                        if (o.isself == true) {
                            ...
                            if (o.id == "module_901" && (scope.isAdshare == "true" ||scope.isCompany == "true")|| (this.objColumn == columnIn && this.siblings.next == j)) {
                        ...
                        if (result.down) {
                            if (o.isself == true) {
                                ...
                                if (!(o.id == "module_901" && (scope.isAdshare == "true" ||scope.isCompany == "true")) && this.objColumn == columnIn && this.siblings.prev == j) {
                                    dragBase.resignBorder(o.id, "up")
                                }
                                else 
                                    dragBase.resignBorder(o.id, "down")
