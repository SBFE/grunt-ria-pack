    ...
    initItems: function(id){
        ...
        if (!items) {
            ...
            for (var i = 0; i < scope.guide_conf[id].data.length; i++) {
                ...
                Core.Events.addEvent(li, Core.Function.bind3(_this.bgEvent, _this, [li, scope.guide_conf[id].data[i]]), 'click');
                
                Core.Events.addEvent(li, Core.Function.bind3(_this.previewEvent, _this, [id, scope.guide_conf[id].data[i]]), 'mouseover');
